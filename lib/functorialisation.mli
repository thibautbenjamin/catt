...
val depth1_interchanger_src : (Coh.t -> (Var.t list) -> ctx -> tm * ty) ref
val depth1_interchanger_tgt : (Coh.t -> (Var.t list) -> ctx -> tm * ty) ref
val depth1_bridge_sub : (sub_ps -> sub_ps -> (Var.t list) -> ctx -> sub_ps) ref
...
val tm_one_step_tm : tm -> (Var.t list) -> ctx -> tm
val ty : ty -> (Var.t list) -> tm -> ctx -> ty
val ctx : ctx -> (Var.t list) -> ctx
val sub : sub_ps -> (Var.t list) -> ctx -> sub_ps
